...
export interface IVerseComponent extends EditionlevelSusceptible, Highlightable, TextFlowSusceptible { }
...
@register(Verse)
export class VerseComponent implements IVerseComponent{
  @Input() data: Verse;
